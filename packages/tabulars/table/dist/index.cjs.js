...
Reflect.defineProperty(TableCollection, util.FLOP_SHUFFLE, {
  value({
    p,
    h,
    w,
    ...
    const key = p !== null && p !== void 0 ? p : rand.flopKey(this);
    const rs = tableSelect.tableShuffle(this[key], {
      h,
      w,
      oscillate
    });
    return keyed ? objectInit.pair(key, rs) : rs;
  },
