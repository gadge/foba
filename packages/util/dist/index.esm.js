...
const flopPropKey$1 = candidates => {
  ...
  return _ref = (_candidates = candidates, allPropKeys$1(_candidates)), Roulett.element(_ref);
};
...
const flopFuncKey = candidates => {
  ...
  return _ref = (_candidates = candidates, allFuncKeys(_candidates)), Roulett.element(_ref);
};
...
const sizeOscillator = (size, stdev = 1) => Roulett.between(size - stdev, size + stdev);
...
export { Flopper, HEAD, LEAP, RAND, SelectMode, Shuffler, TAIL, allFuncKeys, allPropKeys, flopFunc, flopFuncKey, flopProp, flopPropKey, flopShuffleProp, makeEmbedded, shuffle, shuffleObject, shuffleVector, sizeOscillator };
