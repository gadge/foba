import { init, draft } from '@vect/matrix-init';
import { init as init$1 } from '@vect/vector-init';
...
const identityMatrix = (h, w) => init(h, w !== null && w !== void 0 ? w : h, (x, y) => x === y ? 1 : 0);
...
export { MatrixCollection, identityMatrix, lowerPascalMatrix, progressiveRandomMatrix, symmetricPascalMatrix, upperPascalMatrix, zigZagMatrix };
