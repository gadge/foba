...
const absoluteMirror = (l = 5, d = 3) => {
  ...
  let h = ~~(l / 2),
      r = l % 2;
  let positives = (_Object$values = Object.values(Specials), util.Shuffler({
    size: --h
  })(_Object$values));
...
class Foba {
  ...
  static flop({
    ...
    const o = Foba;
    p = p || (_filter = (_o = o, util.allFuncKeys(_o)).filter(x => !x.startsWith('flop')), Roulett.element(_filter));
